...
class ImagePickHelper {
    ...
    public static final int READ_EXTERNAL_STORAGE_REQUEST_CODE_CROP=0x12;
    ...
    public void selectorImage(Activity activity,int permissonType) {
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        if (requestCode == READ_EXTERNAL_STORAGE_REQUEST_CODE) {
            ...
            mCallback.onError();
        }else  if (requestCode == READ_EXTERNAL_STORAGE_REQUEST_CODE_CROP) {
